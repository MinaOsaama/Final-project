...
Q_CONSTINIT static const qt_meta_stringdata_CLASSClientENDCLASS_t qt_meta_stringdata_CLASSClientENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 22),  // "serverResponseReceived"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 8),  // "response"
        QT_MOC_LITERAL(40, 15),  // "connectToServer"
        QT_MOC_LITERAL(56, 11),  // "sendRequest"
        QT_MOC_LITERAL(68, 7),  // "request"
        QT_MOC_LITERAL(76, 11),  // "onReadyRead"
        QT_MOC_LITERAL(88, 12)   // "onDisconnect"
    },
    "Client",
    "serverResponseReceived",
    "",
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->serverResponseReceived((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Client::serverResponseReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Client::serverResponseReceived(const QString & _t1)
{
